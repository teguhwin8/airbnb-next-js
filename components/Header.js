			...
			{searchInput && (
				<div className="flex flex-col col-span-3 mx-auto p-3 shadow-lg my-3 rounded-xl">
					...
					<div className="flex items-center mt-3">
						<button className="flex-grow text-gray-500 hover:text-gray-600" onClick={resetInput}>
							Cancel
						</button>
						<button className="flex-grow text-red-400 hover:text-white hover:bg-red-400 p-3 rounded-full transition duration-150 active:scale-90">
							Search
						</button>
					</div>
				</div>
